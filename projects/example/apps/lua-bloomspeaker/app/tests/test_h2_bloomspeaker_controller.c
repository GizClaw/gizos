...
int main(void) {
  h2_bloomspeaker_hold_tracker_t hold = {0};
  assert(!h2_bloomspeaker_hold_tracker_update(NULL, true, 0u, 1000u));
  assert(!h2_bloomspeaker_hold_tracker_update(&hold, true, 100u, 1000u));
  assert(!h2_bloomspeaker_hold_tracker_update(&hold, true, 1099u, 1000u));
  assert(h2_bloomspeaker_hold_tracker_update(&hold, true, 1100u, 1000u));
  assert(!h2_bloomspeaker_hold_tracker_update(&hold, true, 1200u, 1000u));
  assert(!h2_bloomspeaker_hold_tracker_update(&hold, false, 1250u, 1000u));
  assert(!h2_bloomspeaker_hold_tracker_update(&hold, true, 1300u, 1000u));
  assert(h2_bloomspeaker_hold_tracker_update(&hold, true, 2300u, 1000u));
  assert(!h2_bloomspeaker_hold_tracker_update(&hold, true, 100u, 1000u));
