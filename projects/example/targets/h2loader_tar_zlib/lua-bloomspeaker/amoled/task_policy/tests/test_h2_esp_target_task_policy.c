...
int main(void) {
  ...
  assert_default_policy("lua-bloomspeaker/runner");
  ...
  assert_policy(H2_BLOOMSPEAKER_BLE_TASK_NAME_VALUE, 6u);
  assert_policy(H2_BLOOMSPEAKER_AUDIO_TASK_NAME_VALUE, 7u);
