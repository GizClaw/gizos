...
int main(void) {
  ...
  assert_policy(H2_SIMCOM_PPP_RX_TASK_NAME_VALUE, 7u);
  assert_policy(H2_SIMCOM_CALL_INPUT_TASK_NAME_VALUE, 6u);
  assert_policy(H2_SIMCOM_GNSS_FIX_TASK_NAME_VALUE, 5u);
