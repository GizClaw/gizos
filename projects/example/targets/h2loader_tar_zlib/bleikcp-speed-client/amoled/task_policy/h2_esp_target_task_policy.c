...
static const h2_trie_route_t s_routes[] = {
    ...
    {H2_BLEIKCP_SPEED_KCP_TASK_NAME_VALUE, H2_TRIE_ROUTE_EXACT, handle_policy,
     &s_priority_7_policy},
    {H2_BLEIKCP_SPEED_SERVER_TASK_NAME_VALUE, H2_TRIE_ROUTE_EXACT, handle_policy,
     &s_priority_5_policy},
};
...
enum {
  ROUTE_NODE_CAPACITY = 1u + H2_TRIE_LITERAL_NODE_COUNT(H2LOADER_APP_COMMAND_TASK_NAME_VALUE) +
                        ...
                        H2_TRIE_LITERAL_NODE_COUNT(H2_BLEIKCP_SPEED_KCP_TASK_NAME_VALUE) +
                        H2_TRIE_LITERAL_NODE_COUNT(H2_BLEIKCP_SPEED_SERVER_TASK_NAME_VALUE),
};
