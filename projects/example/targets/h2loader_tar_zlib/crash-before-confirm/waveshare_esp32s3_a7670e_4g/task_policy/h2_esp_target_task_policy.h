...
#define H2_TARGET_TASK_POLICY_NAME                                             \
  "projects/example/targets/h2loader_tar_zlib/crash-before-confirm/"           \
...
#define H2_ESP_TARGET_TASK_POLICY_ROUTES(X)                                    \
  ...
  X("net/modem_ppp_rx", 7u, H2_ESP_TASK_CORE_0, 4096u,                         \
    H2_ESP_TASK_STACK_PSRAM)                                                   \
  X("modem/call_in", 6u, H2_ESP_TASK_CORE_0, 4096u, H2_ESP_TASK_STACK_PSRAM)   \
  X("modem/gnss_fix", 5u, H2_ESP_TASK_CORE_0, 4096u, H2_ESP_TASK_STACK_PSRAM)
