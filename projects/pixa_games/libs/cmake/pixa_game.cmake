...
function(h2_pixa_game_attach target game)
  if(NOT DEFINED H2_PIXA_UPSTREAM_ROOT AND
     DEFINED ENV{H2_PIXA_UPSTREAM_ROOT})
    set(H2_PIXA_UPSTREAM_ROOT "$ENV{H2_PIXA_UPSTREAM_ROOT}")
  endif()
  if(NOT DEFINED H2_PIXELROOT32_UPSTREAM_ROOT AND
     DEFINED ENV{H2_PIXELROOT32_UPSTREAM_ROOT})
    set(H2_PIXELROOT32_UPSTREAM_ROOT
        "$ENV{H2_PIXELROOT32_UPSTREAM_ROOT}")
  endif()
