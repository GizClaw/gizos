#ifndef H2_GIZCLAW_E2E_AMOLED_STATE_H
#define H2_GIZCLAW_E2E_AMOLED_STATE_H
...
typedef struct h2_gizclaw_e2e_amoled_state {
  bool wifi_has_ip;
  bool clock_ready;
  bool runner_started;
  bool runner_complete;
  uint64_t next_summary_replay_ms;
} h2_gizclaw_e2e_amoled_state_t;

typedef enum h2_gizclaw_e2e_amoled_wifi_outcome {
  H2_GIZCLAW_E2E_AMOLED_WIFI_WAIT = 0,
  H2_GIZCLAW_E2E_AMOLED_WIFI_CONNECTED,
  H2_GIZCLAW_E2E_AMOLED_WIFI_NO_SAVED_CONFIG,
  H2_GIZCLAW_E2E_AMOLED_WIFI_RETRY,
} h2_gizclaw_e2e_amoled_wifi_outcome_t;

typedef struct h2_gizclaw_e2e_amoled_wifi_result {
  h2_gizclaw_e2e_amoled_wifi_outcome_t outcome;
  int rc;
} h2_gizclaw_e2e_amoled_wifi_result_t;
