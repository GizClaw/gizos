...
ANDROID_ARM64_PACKAGE_ARTIFACT_COMPATIBILITY = select({
    "//tools/bazel/platforms:is_android_arm64": [],
    "//conditions:default": ["@platforms//:incompatible"],
})
...
AC695N_ARTIFACT_COMPATIBILITY = select({
    "//tools/bazel/platforms:is_ac695n": [],
    "//conditions:default": ["@platforms//:incompatible"],
})
...
PI32V2_UNSUPPORTED_ARTIFACT_COMPATIBILITY = select({
    "//tools/bazel/platforms:is_pi32v2": ["@platforms//:incompatible"],
    "//conditions:default": [],
})
