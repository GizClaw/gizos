/**
 * @file h2_jieli_br35_sdk_port.h
 * @brief Minimal JieLi br35 SDK surface consumed by the PAL core providers.
 *
 * The providers in this component only call these functions, so the native
 * firmware build implements them on top of the SDK (`h2_jieli_br35_sdk_port.c`)
 * while host tests link a deterministic fake. Nothing in this header includes
 * SDK headers; handles are opaque.
 */

#ifndef H2_JIELI_BR35_SDK_PORT_H
#define H2_JIELI_BR35_SDK_PORT_H
...
#endif /* H2_JIELI_BR35_SDK_PORT_H */
