...
#define H2_JIELI_FIRMWARE_VERSION "jieli-br35-dev"
#endif

static h2_pal_result_t
firmware_info_get_current(void *user, h2_pal_firmware_info_t *out_info) {
...
h2_jieli_br35_platform_firmware_info_api(void) {
