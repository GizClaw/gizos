/**
 * @file h2_jieli_br35_sdk_port_fake.h
 * @brief Deterministic single-threaded fake of the br35 SDK port for host tests.
 */

#ifndef H2_JIELI_BR35_SDK_PORT_FAKE_H
#define H2_JIELI_BR35_SDK_PORT_FAKE_H
...
void h2_jieli_fake_set_sem_wait_hook(void (*hook)(void));
...
#endif /* H2_JIELI_BR35_SDK_PORT_FAKE_H */
