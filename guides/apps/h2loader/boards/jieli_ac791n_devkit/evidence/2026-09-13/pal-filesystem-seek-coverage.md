...
Local command logs: `tmp/jieli/pal-seek-wasm.log` and
`tmp/jieli/pal-seek-browser.log`. The actual browser ledger was inspected in
`bazel-testlogs/projects/e2e/targets/pkg_tar/pal/browser_test/test.log`.
Neither result substitutes for JieLi hardware execution.
