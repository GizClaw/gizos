...
| 后续正式包回归 | [PAL final acceptance](../boards/jieli_ac791n_devkit/evidence/2026-09-14/pal-final-acceptance.md)：不同 Loader 更新、UART 25/25 与 BLE 22/22 两轮；具体源码及镜像身份以记录为准 |
