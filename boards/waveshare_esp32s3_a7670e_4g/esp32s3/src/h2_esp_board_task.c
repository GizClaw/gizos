...
#ifdef H2_ESP_BOARD_TASK_HOST_TEST
...
#define H2_WAVESHARE_A7670E_ENTRY_TASK_STACK_SIZE 65536u
...
h2_pal_result_t h2_esp_board_start_entry_task(
    ...
    BaseType_t result = xTaskCreatePinnedToCoreWithCaps(
        entry_task, name, H2_WAVESHARE_A7670E_ENTRY_TASK_STACK_SIZE, context,
