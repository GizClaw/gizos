...
static const h2_esp_layout_policy_entry_t s_entries[] = {
    ...
    {"net/modem_ppp_rx", 7u, H2_ESP_TASK_CORE_0, 4096u,
     H2_ESP_TASK_STACK_PSRAM},
    {"modem/call_in", 6u, H2_ESP_TASK_CORE_0, 4096u, H2_ESP_TASK_STACK_PSRAM},
    {"modem/gnss_fix", 5u, H2_ESP_TASK_CORE_0, 4096u, H2_ESP_TASK_STACK_PSRAM},
};
